...
public class A43_Static_keyword {
    ...
    st2.increase();//If you comment this str1.staticVar will be same as staticVar of staticDemo
    System.out.println("Static variable with st1 object: " + st1.staticVar);//You can do this st2 also
    System.out.println("Static variable with st2 object: " + st2.staticVar);
    }
}
